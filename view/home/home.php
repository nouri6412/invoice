<div class="wrap invoice-main">
    <div class="row">
        <div class="col">
            <div style="background:#2c9eef;" class="admin-woo-tile">
                <h3>موجودی بانک</h3>
                <hr>
        ...
        <div class="col">
            <div style="background:#ef2c2c;" class="admin-woo-tile">
                <h3>هزینه</h3>
                <hr>
        ...
        <div class="col">
            <div style="background:#efaa2c;" class="admin-woo-tile">
                <h3>درآمد</h3>
                <hr>
        ...
        <div class="col">
            <div style="background:#bf54f5;" class="admin-woo-tile">
                <h3>سودوزیان</h3>
                <hr>
