...
<div class="wrap invoice-main">
    <h2><?php echo $this->model['label']; ?></h2>
    <?php global $Admin_Woo_Invoice_Core;
    $Admin_Woo_Invoice_Core->print_alert(); ?>
    ...
    <div class="table-header">
        <div>
            ...
            ?>
                <button onclick="admin_woo_model_form('<?php echo esc_attr($this->model['name']); ?>',0)" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#invoice-model-form">
