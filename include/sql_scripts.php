...
class Admin_Woo_Invoice_Sql_Scripts
{
  ...
  {
    global $wpdb;
    $table_name = $wpdb->prefix . "invoice_model";
    ...
    $table_name = $wpdb->prefix . "invoice_model_type";
    $sql .= "CREATE TABLE $table_name (
    ...
    $table_name = $wpdb->prefix . "invoice_model_type_meta";
    $sql .= "CREATE TABLE $table_name (
                    `id` BIGINT(18) NOT NULL AUTO_INCREMENT,
                    `type_id` BIGINT(18) NOT NULL,
  ...
  PRIMARY KEY (`id`)
    ...
    $table_name = $wpdb->prefix . "invoice_model_meta";
    $sql .= "CREATE TABLE $table_name (
            `id` BIGINT(18) NOT NULL AUTO_INCREMENT,
