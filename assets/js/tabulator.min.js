...
!(function (e, t) {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.column.definition.cssClass) &&
                                this.column.definition.cssClass.split(" ").forEach(function (t) {
                                    e.classList.add(t);
                                });
            ...
            return (
                o(r, [
                        ...
                        value: function (t, i) {
                            ...
                            switch (e(n)) {
                                case "object":
                                    n instanceof Node
                                        ? t.appendChild(n)
                                        : ((t.innerHTML = ""), console.warn("Format Error - Title formatter has returned a type of object, the only valid formatter object return is an instance of Node, the formatter returned:", n));
                                    break;
                                case "undefined":
                                    t.innerHTML = "";
                                    break;
                    ...
                    },
                    {
                        key: "_setNestedData",
                        value: function (e, t) {
                            for (var i = e, n = this.fieldStructure, o = n.length, a = 0; a < o; a++)
                                if (a == o - 1) i[n[a]] = t;
                                else {
                                    if (!i[n[a]]) {
                                        if (void 0 === t) break;
                        ...
                        value: function (e) {
                            ...
                            return this.isGroup || this.parent.isGroup
                                ...
                                : ((t = Object.assign({}, this.getDefinition())),
                                  (t = Object.assign(t, e)),
                                  this.table.columnManager.addColumn(t, !1, this).then(function (e) {
                                      return (
    ...
    var k = (function () {
                            ...
                            var s = function () {
                                ...
                                null == s ||
                                    ...
                                    ((u = o.findIndex(function (e) {
                                        ...
                                        ? (i[l] = o[u].copy)
                                        : ((c = Object.assign(Array.isArray(s) ? [] : {}, s)), o.unshift({ subject: s, copy: c }), (i[l] = n.deepClone(s, c, o))));
                            };
                            for (var l in t) s();
                            return i;
                        },
                            ...
                            return new Promise(function (s, l) {
                                if (o > -1) {
                                    if (
                                        ...
                                        !i && k.elVisible(a) && (r = k.elOffset(a).top - k.elOffset(n.elementVertical).top) > 0 && r < n.elementVertical.clientHeight - a.offsetHeight)
                                    )
                                        return s(), !1;
                                    switch ((void 0 === t && (t = n.table.options.scrollToRowPosition), "nearest" === t && (t = n.scrollToRowNearestTop(e) ? "top" : "bottom"), n.scrollToRow(e), t)) {
                                        case "middle":
                                        case "center":
                                            n.elementVertical.scrollHeight - n.elementVertical.scrollTop == n.elementVertical.clientHeight
                                                ? (n.elementVertical.scrollTop = n.elementVertical.scrollTop + (a.offsetTop - n.elementVertical.scrollTop) - (n.elementVertical.scrollHeight - a.offsetTop) / 2)
                                                : (n.elementVertical.scrollTop = n.elementVertical.scrollTop - n.elementVertical.clientHeight / 2);
                                            break;
                                        case "bottom":
                                            n.elementVertical.scrollHeight - n.elementVertical.scrollTop == n.elementVertical.clientHeight
                                                ? (n.elementVertical.scrollTop = n.elementVertical.scrollTop - (n.elementVertical.scrollHeight - a.offsetTop) + a.offsetHeight)
                                                : (n.elementVertical.scrollTop = n.elementVertical.scrollTop - n.elementVertical.clientHeight + a.offsetHeight);
                                            break;
                                        case "top":
            ...
            return (
                o(n, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this.options("columns"),
                                t = !0;
                            return (
                                "fitDataTable" == this.options("layout") && (console.warn("Horizontal Virtual DOM is not compatible with fitDataTable layout mode"), (t = !1)),
                                this.options("responsiveLayout") && (console.warn("Horizontal Virtual DOM is not compatible with responsive columns"), (t = !1)),
                                this.options("rtl") && (console.warn("Horizontal Virtual DOM is not currently compatible with RTL text direction"), (t = !1)),
                                e &&
                                    e.find(function (e) {
                                        return e.frozen;
                                    }) &&
                                    (console.warn("Horizontal Virtual DOM is not compatible with frozen columns"), (t = !1)),
                                t
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            var i = this,
                                n = { cols: this.columns, leftCol: this.leftCol, rightCol: this.rightCol },
                                o = 0;
                            (e && !this.initialized) ||
                                (this.clear(),
                                ...
                                this.table.columnManager.columnsByIndex.forEach(function (e) {
                                    ...
                                    if (e.visible) {
                                        ...
                                        (t.leftPos = o),
                                            (t.rightPos = o + n),
                                            (t.width = n),
                                            i.isFitData && (t.fitDataCheck = !e.modules.vdomHoz || e.modules.vdomHoz.fitDataCheck),
                                            o + n > i.vDomScrollPosLeft && o < i.vDomScrollPosRight
                                                ? (-1 == i.leftCol && ((i.leftCol = i.columns.length), (i.vDomPadLeft = o)), (i.rightCol = i.columns.length))
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            (this.vDomScrollPosLeft += e),
                                ...
                                Math.abs(e) > this.windowBuffer / 2 ? this.rerenderColumns() : e > 0 ? (this.addColRight(), this.removeColLeft()) : (this.addColLeft(), this.removeColRight());
                        },
                    },
                    {
                                    ...
                                    i = function () {
                                        ...
                                        return i && i.modules.vdomHoz.leftPos <= e.vDomScrollPosRight
                                            ? ((t = !0),
                                              ...
                                              e.rightCol++,
                                              void (e.rightCol >= e.columns.length - 1 ? (e.vDomPadRight = 0) : (e.vDomPadRight -= i.getWidth())))
                                            : "break";
                                    };
                                ;
                                ...
                                var e = this,
                                    ...
                                    i = function () {
                                        ...
                                        (t = !0),
                                            ...
                                            e.leftCol--,
                                            e.leftCol <= 0 ? (e.vDomPadLeft = 0) : (e.vDomPadLeft -= i.getWidth());
                    ...
                    },
                    {
                        ...
                        value: function (e, t, i, n, o) {
                            ...
                            r > -1 &&
                                ...
                                e.splice(a, 0, t),
                                o &&
                                    (this.chain("column-moving-rows", [t, i, n], null, []) || []).concat(this.table.rowManager.rows).forEach(function (e) {
                                        if (e.cells.length) {
        ...
        D = (function (e) {
            ...
            function n(e, o) {
                var a,
                    r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "row";
                return (
                    t(this, n),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return new Promise(function (a, r) {
                                ...
                                i.subscribed("row-data-changing") && ((o = Object.assign(o, i.data)), (o = Object.assign(o, e))),
                                ...
                                n ? (i.normalizeHeight(!0), i.table.options.rowFormatter && i.table.options.rowFormatter(i.getComponent())) : ((i.initialized = !1), (i.height = 0), (i.heightStyled = "")),
                                    i.dispatch("row-data-changed", i, n, e),
                                    i.dispatchExternal("rowUpdated", i.getComponent()),
                                    i.subscribedExternal("dataChanged") && i.dispatchExternal("dataChanged", i.table.rowManager.getData()),
                                    a();
                            });
                        },
                    },
            ...
            return (
                o(n, [
                    ...
                    },
                    {
                        key: "rerenderRows",
                        value: function (e) {
                            for (var t = this.elementVertical.scrollTop, i = !1, n = !1, o = this.table.rowManager.scrollLeft, a = this.rows(), r = this.vDomTop; r <= this.vDomBottom; r++)
                                if (a[r]) {
                            ...
                            a.forEach(function (e) {
                                ...
                                e && e(),
                                this._virtualRenderFill(!1 === i ? this.rows.length - 1 : i, !0, n || 0),
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            if (((this.scrollTop = e), -i > o || n > o)) {
                                ...
                                t
                                    ? (i < 0 && this._addTopRow(a, -i), n < 0 && (this.vDomScrollHeight - this.scrollTop > this.vDomWindowBuffer ? this._removeBottomRow(a, -n) : (this.vDomScrollPosBottom = this.scrollTop)))
                                    : (n >= 0 && this._addBottomRow(a, n), i >= 0 && (this.scrollTop > this.vDomWindowBuffer ? this._removeTopRow(a, i) : (this.vDomScrollPosTop = this.scrollTop)));
                        },
                    },
                    {
                        key: "resize",
                    ...
                    },
                    {
                        ...
                        value: function (e, t, i) {
                            ...
                            if (((i = i || 0), (e = e || 0))) {
                                ...
                                (s = (h - e + 1) * this.vDomRowHeight) < d && (e -= Math.ceil((d - s) / this.vDomRowHeight)) < 0 && (e = 0),
                                    (e -= a = Math.min(Math.max(Math.floor(this.vDomWindowBuffer / this.vDomRowHeight), this.vDomWindowMinMarginRows), e));
                            } else this.clear();
                            if (h && k.elVisible(this.elementVertical)) {
                                ...
                                e
                                    ? ((this.vDomTopPad = t ? this.vDomRowHeight * this.vDomTop + i : this.scrollTop - l), (this.vDomBottomPad = this.vDomBottom == h - 1 ? 0 : Math.max(this.vDomScrollHeight - this.vDomTopPad - r - l, 0)))
                                    : ((this.vDomTopPad = 0), (this.vDomRowHeight = Math.floor((r + l) / u)), (this.vDomBottomPad = this.vDomRowHeight * (h - this.vDomBottom - 1)), (this.vDomScrollHeight = l + r + this.vDomBottomPad - d)),
                                    (n.style.paddingTop = this.vDomTopPad + "px"),
                                    (n.style.paddingBottom = this.vDomBottomPad + "px"),
                                    t && (this.scrollTop = this.vDomTopPad + l + i - (this.elementVertical.scrollWidth > this.elementVertical.clientWidth ? this.elementVertical.offsetHeight - d : 0)),
                                    (this.scrollTop = Math.min(this.scrollTop, this.elementVertical.scrollHeight - d)),
                                    this.elementVertical.scrollWidth > this.elementVertical.offsetWidth && t && (this.scrollTop += this.elementVertical.offsetHeight - d),
                        ...
                        value: function (e, t) {
                            for (var i = this.tableElement, n = [], o = 0, a = this.vDomTop - 1, r = 0; this.vDomTop; ) {
                                ...
                                this.styleRow(s, a),
                                    ...
                                    s.initialize(),
                                    u || ((l = s.getElement().offsetHeight) > this.vDomWindowBuffer && (this.vDomWindowBuffer = 2 * l)),
                                    (t -= l),
                                    (o += l),
                                    this.vDomTop--,
                                    a--,
                            ...
                            this._quickNormalizeRowHeight(n),
                                o && ((this.vDomTopPad -= o), this.vDomTopPad < 0 && (this.vDomTopPad = a * this.vDomRowHeight), a < 1 && (this.vDomTopPad = 0), (i.style.paddingTop = this.vDomTopPad + "px"), (this.vDomScrollPosTop -= o));
                        },
                    },
                    {
                        key: "_removeTopRow",
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            this._quickNormalizeRowHeight(n),
                                o && ((this.vDomBottomPad -= o), (this.vDomBottomPad < 0 || a == e.length - 1) && (this.vDomBottomPad = 0), (i.style.paddingBottom = this.vDomBottomPad + "px"), (this.vDomScrollPosBottom += o));
                        },
                    },
                    {
                ...
                o(r, [
                            ...
                            this.initializePlaceholder(),
                                ...
                                this.element.addEventListener("scroll", function () {
                                    var t = e.element.scrollLeft,
                                        ...
                                        o = e.scrollTop > n;
                                    e.scrollLeft != t && ((e.scrollLeft = t), e.dispatch("scroll-horizontal", t, i), e.dispatchExternal("scrollHorizontal", t, i), e._positionPlaceholder()),
                                        e.scrollTop != n && ((e.scrollTop = n), e.renderer.scrollRows(n, o), e.dispatch("scroll-vertical", n, o), e.dispatchExternal("scrollVertical", n, o));
                                });
                        },
                    },
                    {
                        ...
                        value: function (e, t, i) {
                            ...
                            return new Promise(function (o, a) {
                                t && n.getDisplayRows().length
                                    ...
                                    : (n.table.options.autoColumns && i && n.table.initialized && n.table.columnManager.generateColumnsFromRowData(e), n.resetScroll(), n._setDataActual(e)),
                                    o();
                            });
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (e, t, i, n) {
                            var o,
                                ...
                                l = -1;
                            return (
                                i || ((a = this.chain("row-adding-position", [r, s], null, { index: i, top: s })), (i = a.index), (s = a.top)),
                                void 0 !== i && (i = this.findRow(i)),
                                (i = this.chain("row-adding-index", [r, i, s], null, i)) && (l = this.rows.indexOf(i)),
                                i && l > -1
                        ...
                        value: function (e, t, i) {
                            ...
                            if ("function" == typeof e)
                                if (
                                    ...
                                    (o = "dataPipeline"), t && (a == this.dataPipeline.length - 1 ? (o = "display") : a++);
                                else {
                                    if (
                                        !(
                            ...
                            this.redrawBlock
                                ? (!this.redrawBlockRestoreConfig ||
                                      (this.redrawBlockRestoreConfig && ((this.redrawBlockRestoreConfig.stage === o && a < this.redrawBlockRestoreConfig.index) || r.indexOf(o) < r.indexOf(this.redrawBlockRestoreConfig.stage)))) &&
                                  (this.redrawBlockRestoreConfig = { handler: e, skipStage: t, renderInPosition: i, stage: o, index: a })
                                : (k.elVisible(this.element)
                                      ? i
                                          ? this.reRenderInPosition(this.refreshPipelines.bind(this, e, o, a, i))
                                          : (this.refreshPipelines(e, o, a, i), e || this.table.columnManager.renderer.renderColumns(), this.renderTable(), n.options.layoutColumnsOnNewData && this.table.columnManager.redraw(!0))
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            var i = !0;
                            return (
                                t && void 0 !== this.displayRows[t] ? ((this.displayRows[t] = e), (i = !0)) : (this.displayRows.push(e), (i = t = this.displayRows.length - 1)),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.dispatchExternal("renderStarted"),
                                ...
                                this._clearTable(),
                                this.displayRowsCount ? (this.renderer.renderRows(), this.firstRender && ((this.firstRender = !1), this.layoutRefresh())) : this.renderEmptyScroll(),
                        ...
                        value: function () {
                            ...
                            if ("fill" === this.renderer.verticalFillMode) {
                                ...
                                this.fixedHeight
                                    ...
                                    : ((this.element.style.height = ""), (this.element.style.height = this.table.element.clientHeight - t + "px"), (this.element.scrollTop = this.scrollTop)),
                                    this.renderer.resize(),
                                    this.fixedHeight || e == this.element.clientHeight || (this.subscribed("table-resize") ? this.dispatch("table-resize") : this.redraw());
                            }
        ...
        H = (function (e) {
            ...
            function n(e) {
                ...
                return (
                    ...
                    (o.previousTargets = {}),
                    (o.listeners = ["click", "dblclick", "contextmenu", "mouseenter", "mouseleave", "mouseover", "mouseout", "mousemove", "touchstart", "touchend"]),
                    (o.componentMap = { "tabulator-cell": "cell", "tabulator-row": "row", "tabulator-group": "group", "tabulator-col": "column" }),
                    (o.pseudoTrackers = { row: { subscriber: null, target: null }, cell: { subscriber: null, target: null }, group: { subscriber: null, target: null }, column: { subscriber: null, target: null } }),
                    (o.pseudoTracking = !1),
                    o
                );
            }
                    ...
                    },
                    {
                        ...
                        value: function (e, t, i) {
                            var n = this.listeners[t].components,
                                o = n.indexOf(e),
                                a = !1;
                            i ? -1 === o && (n.push(e), (a = !0)) : this.subscribed(e + "-" + t) || (o > -1 && (n.splice(o, 1), (a = !0))),
                                ...
                                var l = function () {
                                    ...
                                    if (l && l.target === s) o = l.component;
                                        ...
                                        switch (e) {
                                            case "row":
                                            case "group":
                                                if (a.components.includes("row") || a.components.includes("cell") || a.components.includes("group"))
                                                    (o = n.table.rowManager.getVisibleRows(!0).find(function (e) {
                        ...
                        value: function (t, i, n, o, a, r) {
                            ...
                            return (
                                ...
                                this.confirm("data-loading", [t, i, n, a])
                                    ? ((this.loading = !0),
                                      a || this.alertLoader(),
                                      (i = this.chain("data-params", [t, n, a], i || {}, i || {})),
                                      (i = this.mapParams(i, this.table.options.dataSendParams)),
                                      this.chain("data-load", [t, i, n, a], !1, Promise.resolve([]))
                                          .then(function (t) {
                                              ...
                                              l == s.requestOrder
                                                  ? (s.clearAlert(), !1 !== i && (s.dispatchExternal("dataLoaded", i), s.table.rowManager.setData(i, o, void 0 === r ? !o : r)))
        ...
        B = (function () {
            function e(i) {
                t(this, e),
                    ...
                    (this.chain = i ? this._debugChain.bind(this) : this._chain.bind(this)),
                    (this.confirm = i ? this._debugConfirm.bind(this) : this._confirm.bind(this)),
                    (this.debug = i);
            }
            return (
                o(e, [
                    ...
                    },
                    {
                        ...
                        value: function (t, i) {
                            ...
                            if ("string" == typeof t) {
                                ...
                                ("undefined" != typeof HTMLElement && t instanceof HTMLElement) || t instanceof Y
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            var t,
                                i,
                                n,
                                o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "right",
                                a = k.elOffset(e);
                            ...
                            return (
                                this.destroyed ||
                                    ...
                                    (e instanceof HTMLElement
                                        ? ((o = e), (a = (r = this.elementPositionCoords(e, t)).offset), (i = r.x), (n = r.y))
                                        : "number" == typeof e
                                        ? ((a = { top: 0, left: 0 }), (i = e), (n = t))
                                        : ((i = (r = this.containerEventCoords(e)).x), (n = r.y), (this.reversedX = !1)),
                        ...
                        value: function (e, t, i, n, o) {
                            ...
                            if (
                                ((e + this.element.offsetWidth >= this.container.offsetWidth || this.reversedX) &&
                                    ((this.element.style.left = ""), (this.element.style.right = i ? this.container.offsetWidth - n.left + "px" : this.container.offsetWidth - e + "px"), (this.reversedX = !0)),
                                t + this.element.offsetHeight > Math.max(this.container.offsetHeight, a ? this.container.scrollHeight : 0))
                            )
                                if (i)
                                    switch (o) {
                                        case "bottom":
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return (
                                ...
                                this.visible &&
                                    (setTimeout(function () {
                                        t.table.rowManager.element.addEventListener("scroll", t.blurEvent),
                                            t.subscribe("cell-editing", t.blurEvent),
                                            document.body.addEventListener("click", t.blurEvent),
                                            document.body.addEventListener("contextmenu", t.blurEvent),
                    ...
                    return (
                        e.forEach(function (e, a) {
                            ...
                            e.column.minWidth >= r
                                ...
                                ? ((e.width = e.column.maxWidth), (t -= e.column.maxWidth), (u -= n ? e.column.definition.widthShrink || 1 : e.column.definition.widthGrow || 1) && (i = Math.floor(t / u)))
                                : (p.push(e), (m += n ? e.column.definition.widthShrink || 1 : e.column.definition.widthGrow || 1));
                        }),
                        o.length
                            ? (o.forEach(function (e) {
                ...
                this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update(),
                    ...
                    e.forEach(function (e) {
                        ...
                        e.visible &&
                            ...
                            t
                                ? ((n = h(t)), (o += n > i ? n : i), e.definition.widthShrink && (l.push({ column: e, width: n > i ? n : i }), (u += e.definition.widthShrink)))
                                : (s.push({ column: e, width: 0 }), (r += e.definition.widthGrow || 1)));
                    }),
                    (a = n - o),
                    (t = Math.floor(a / r)),
                    (c = d(s, a, t, !1)),
                    ...
                    (i = Math.abs(c) + a) > 0 && u && (c = d(l, i, Math.floor(i / u), !0)),
                ...
                },
                {
                    ...
                    value: function (t) {
                        if ((!0 === (t = t || "default") && navigator.language && (t = navigator.language.toLowerCase()), t && !this.langList[t])) {
                            var i = t.split("-")[0];
                            this.langList[i]
                                ? (console.warn("Localization Error - Exact matching locale not found, using closest match: ", t, i), (t = i))
    ...
    X.moduleName = "comms";
    var q = Object.freeze({ __proto__: null, LayoutModule: G, LocalizeModule: U, CommsModule: X }),
        K = (function () {
            function i(e, n) {
                ...
                o(i, [
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            (this.columnManager = new M(this)),
                                ...
                                (this.externalEvents = new A(this, this.options, this.options.debugEventsExternal)),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            n.height && ((n.height = isNaN(n.height) ? n.height : n.height + "px"), (i.style.height = n.height)),
                                !1 !== n.minHeight && ((n.minHeight = isNaN(n.minHeight) ? n.minHeight : n.minHeight + "px"), (i.style.minHeight = n.minHeight)),
                                !1 !== n.maxHeight && ((n.maxHeight = isNaN(n.maxHeight) ? n.maxHeight : n.maxHeight + "px"), (i.style.maxHeight = n.maxHeight));
                        },
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            return (
                                this.options.debugInitialization &&
                                    !this.initialized &&
                                    (e || (e = " " == (n = "Error" == (i = new Error().stack.split("\n"))[0] ? i[2] : i[1])[0] ? n.trim().split(" ")[1].split(".")[1] : n.trim().split("@")[0]),
                                    console.warn(
    ...
    var $ = (function (i) {
        ...
        function r(e) {
            ...
            return (
                t(this, r),
                ((i = n.call(this, e)).allowedTypes = ["", "data", "download", "clipboard", "print", "htmlOutput"]),
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        this.allowedTypes.forEach(function (o) {
                            ...
                            e.definition[r] && (a = t.lookupAccessor(e.definition[r])) && ((i = !0), (n[r] = { accessor: a, params: e.definition[r + "Params"] || {} }));
                        }),
                        ...
                        return (
                            this.table.columnManager.traverse(function (e) {
                                ...
                                e.modules.accessor &&
                                    ...
                                    ((l = e.getComponent()), (s = "function" == typeof r.params ? r.params(a, o, t, l, n) : r.params), e.setFieldValue(o, r.accessor(a, o, t, s, l, n)));
                            }),
                            o
                        );
                    },
    ...
    function Z(t, i) {
        ...
        else if ("object" === e(t)) for (var o in t) n = n.concat(Z(t[o], i ? i + "[" + o + "]" : o));
    ...
    function te(t, i) {
        ...
        else if ("object" === e(t)) for (var o in t) n = n.concat(te(t[o], i ? i + "[" + o + "]" : o));
        else n.push({ key: i, value: t });
        return n;
    }
    var ie = {
                ...
                o(n, [
                    {
                        key: "initialize",
                        value: function () {
                            (this.loaderPromise = this.table.options.ajaxRequestFunc || n.defaultLoaderPromise),
                                (this.urlGenerator = this.table.options.ajaxURLGenerator || n.defaultURLGenerator),
    ...
    (ne.moduleName = "ajax"),
        ...
        (ne.defaultLoaderPromise = function (t, i, n) {
            ...
            return new Promise(function (r, s) {
                if (((t = a.urlGenerator.call(a.table, t, i, n)), "GET" != i.method.toUpperCase()))
                    if ((o = "object" === e(a.table.options.ajaxContentType) ? a.table.options.ajaxContentType : a.contentTypeFormatters[a.table.options.ajaxContentType])) {
                ...
                t
                    ? (void 0 === i.headers && (i.headers = {}),
                      void 0 === i.headers.Accept && (i.headers.Accept = "application/json"),
                      void 0 === i.headers["X-Requested-With"] && (i.headers["X-Requested-With"] = "XMLHttpRequest"),
                      void 0 === i.mode && (i.mode = "cors"),
                      "cors" == i.mode ? (void 0 === i.headers.Origin && (i.headers.Origin = window.location.origin), void 0 === i.credentials && (i.credentials = "same-origin")) : void 0 === i.credentials && (i.credentials = "include"),
                      fetch(t, i)
                          .then(function (e) {
                              e.ok
                                  ? e
                        ...
                        (this.mode = this.table.options.clipboard),
                            ...
                            (!0 !== this.mode && "copy" !== this.mode) ||
                                this.table.element.addEventListener("copy", function (t) {
                                    var i, n;
                                    if (!e.blocked) {
                                        if ((t.preventDefault(), e.customSelection)) (i = e.customSelection), e.table.options.clipboardCopyFormatter && (i = e.table.options.clipboardCopyFormatter("plain", i));
                                        else {
                                            ...
                                            (i = (n = e.table.modules.export.genereateHTMLTable(o)) ? e.generatePlainContent(o) : ""),
                                                e.table.options.clipboardCopyFormatter && ((i = e.table.options.clipboardCopyFormatter("plain", i)), (n = e.table.options.clipboardCopyFormatter("html", n)));
                                        }
                                        window.clipboardData && window.clipboardData.setData
                                            ...
                                            ? (t.clipboardData.setData("text/plain", i), n && t.clipboardData.setData("text/html", n))
                                            : t.originalEvent && t.originalEvent.clipboardData.setData && (t.originalEvent.clipboardData.setData("text/plain", i), n && t.originalEvent.clipboardData.setData("text/html", n)),
                        ...
                        return (
                            t.forEach(function (t) {
                                ...
                                t.columns.forEach(function (i) {
                                    var o = "";
                                    if (i)
                                        if (("group" === t.type && (i.value = i.component.getKey()), null === i.value)) o = "";
                                        else
                                            switch (e(i.value)) {
                                                case "object":
                        ...
                        (this.blocked = !1),
                            ...
                            (!0 !== this.mode && "copy" !== this.mode) ||
                                ...
                                void 0 !== window.getSelection && void 0 !== document.createRange
                                    ...
                                    : void 0 !== document.selection && void 0 !== document.body.createTextRange && ((n = document.body.createTextRange()).moveToElementText(this.table.element), n.select()),
                    ...
                    value: function (e) {
                        ...
                        this.checkPaseOrigin(e) &&
                            ...
                            (i = this.pasteParser.call(this, t))
                                ? (e.preventDefault(), this.table.modExists("mutator") && (i = this.mutateData(i)), (n = this.pasteAction.call(this, i)), this.dispatchExternal("clipboardPasted", t, i, n))
                        ...
                        value: function () {
                            ...
                            (this.topCalcs.length || this.botCalcs.length) &&
                                ...
                                this.table.options.groupBy &&
                                    ...
                                    this.table.modules.groupRows.getChildGroups().forEach(function (t) {
                                        e.recalcGroup(t);
                                    }));
                        },
                    },
                                ...
                                (i.generateCells = function () {
                                    ...
                                    n.table.columnManager.columnsByIndex.forEach(function (o) {
                                        n.genColumn.setField(o.getField()),
                                            ...
                                            o.definition[e + "CalcFormatter"] && n.table.modExists("format")
                                                ? (n.genColumn.modules.format = { formatter: n.table.modules.format.getFormatter(o.definition[e + "CalcFormatter"]), params: o.definition[e + "CalcFormatterParams"] || {} })
                                                : (n.genColumn.modules.format = { formatter: n.table.modules.format.getFormatter("plaintext"), params: {} }),
                            ...
                            return (
                                a.forEach(function (e) {
                                    ...
                                    e.modules.columnCalcs &&
                                        ...
                                        (n = r + "Params"),
                                        (i = "function" == typeof e.modules.columnCalcs[n] ? e.modules.columnCalcs[n](a, t) : e.modules.columnCalcs[n]),
                        ...
                        value: function () {
                            ...
                            return (
                                this.table.options.groupBy && this.table.modExists("groupRows")
                                    ? this.table.modules.groupRows.getGroups(!0).forEach(function (i) {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return (
                                ...
                                { top: i.calcs.top ? i.calcs.top.getData() : {}, bottom: i.calcs.bottom ? i.calcs.bottom.getData() : {}, groups: o }
                            );
                        },
                    },
                ]),
    ...
    var le = (function (i) {
        ...
        function r(e) {
            ...
            return (
                ...
                i.registerComponentFunction("row", "treeCollapse", i.collapseRow.bind(l(i))),
                i.registerComponentFunction("row", "treeExpand", i.expandRow.bind(l(i))),
                i.registerComponentFunction("row", "treeToggle", i.toggleRow.bind(l(i))),
                i.registerComponentFunction("row", "getTreeParent", i.getTreeParent.bind(l(i))),
                i.registerComponentFunction("row", "getTreeChildren", i.getRowChildren.bind(l(i))),
                i.registerComponentFunction("row", "addTreeChild", i.addTreeChildRow.bind(l(i))),
                i.registerComponentFunction("row", "isTreeExpanded", i.isRowExpanded.bind(l(i))),
                i
            );
        }
        return (
            o(r, [
                            ...
                            switch (
                                ...
                                i.dataTreeBranchElement &&
                                    (!0 === i.dataTreeBranchElement
                                        ...
                                        ? (((t = document.createElement("div")).innerHTML = i.dataTreeBranchElement), (this.branchEl = t.firstChild))
                                        : (this.branchEl = i.dataTreeBranchElement)),
                                i.dataTreeCollapseElement
                                    ? "string" == typeof i.dataTreeCollapseElement
                                        ? (((t = document.createElement("div")).innerHTML = i.dataTreeCollapseElement), (this.collapseEl = t.firstChild))
                                ...
                                i.dataTreeExpandElement
                                    ? "string" == typeof i.dataTreeExpandElement
                                        ? (((t = document.createElement("div")).innerHTML = i.dataTreeExpandElement), (this.expandEl = t.firstChild))
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        !o && t.modules.dataTree && t.modules.dataTree.branchEl && t.modules.dataTree.branchEl.parentNode.removeChild(t.modules.dataTree.branchEl),
                            !o && t.modules.dataTree && t.modules.dataTree.controlEl && t.modules.dataTree.controlEl.parentNode.removeChild(t.modules.dataTree.controlEl),
                            (t.modules.dataTree = {
                    ...
                    value: function (e, t) {
                        ...
                        return (
                            !1 !== n.children &&
                                ...
                                (o = this.table.modExists("filter") && this.table.options.dataTreeFilter ? this.table.modules.filter.filter(n.children) : n.children),
                                this.table.modExists("sort") && this.table.options.dataTreeSort && this.table.modules.sort.sort(o),
                                o.forEach(function (e) {
                                    a.push(e),
                        ...
                        return (
                            ...
                            n.forEach(function (n) {
                                ...
                                o.create(),
                                    ...
                                    o.modules.dataTree.children && (o.modules.dataTree.open = t.startOpen(o.getComponent(), o.modules.dataTree.index)),
                                    i.push(o);
                            }),
                            i
                        );
                ...
                },
                {
                    ...
                    value: function (e, t, i, n) {
                        ...
                        "string" == typeof t && (t = JSON.parse(t)),
                            ...
                            void 0 !== n && !1 !== (o = this.findChildIndex(n, e)) && e.data[this.field].splice(i ? o : o + 1, 0, t),
                ...
                },
                {
                    ...
                    value: function (t, i) {
                        ...
                        return (
                            ...
                            o && (Array.isArray(i.data[this.field]) && (o = i.data[this.field].indexOf(o)), -1 == o && (o = !1)),
                            o
                        );
                    },
                },
    ...
    var ue = {
            ...
            pdf: function (t, i, n) {
                ...
                i && i.autoTable && (r = "function" == typeof i.autoTable ? i.autoTable(d) || {} : i.autoTable),
                    c &&
                    ...
                    return (
                        t.forEach(function (t, o) {
                            ...
                            t.columns.forEach(function (t, i) {
                                t
                                    ? (a.push(t.value instanceof Date || "object" !== e(t.value) ? t.value : JSON.stringify(t.value)),
                                      (t.width > 1 || t.height > -1) && (t.height > 1 || t.width > 1) && n.push({ s: { r: o, c: i }, e: { r: o + t.height - 1, c: i + t.width - 1 } }))
                                    : a.push("");
                            }),
                                i.push(a);
                        }),
        ...
        ce = (function (e) {
            ...
            function n(e) {
                ...
                return (
                    t(this, n),
                    (o = i.call(this, e)).registerTableOption("downloadReady", function (e, t) {
                        return t;
                    }),
                        ...
                        value: function (e, t, i, n, o) {
                            ...
                            (r = this.table.options.downloadReady(e, r)) &&
                                (o
                                    ...
                                    : (a.setAttribute("href", window.URL.createObjectURL(r)),a.setAttribute("data-noajax", 'noajax'), a.setAttribute("download", n), (a.style.display = "none"), document.body.appendChild(a), a.click(), document.body.removeChild(a)),
            ...
            o(i, [
                {
                    ...
                    value: function () {
                        this.params.listItemFormatter && console.warn("The listItemFormatter editor param has been deprecated, please see the latest editor documentation for updated options"),
                            this.params.sortValuesList && console.warn("The sortValuesList editor param has been deprecated, please see the latest editor documentation for updated options"),
                            this.params.searchFunc && console.warn("The searchFunc editor param has been deprecated, please see the latest editor documentation for updated options"),
                            this.params.searchingPlaceholder && console.warn("The searchingPlaceholder editor param has been deprecated, please see the latest editor documentation for updated options");
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        if (
                            (i.setAttribute("type", this.params.clearable ? "search" : "text"),
                            (i.style.padding = "4px"),
                            (i.style.width = "100%"),
                            (i.style.boxSizing = "border-box"),
                            this.params.autocomplete || ((i.style.cursor = "default"), (i.style.caretColor = "transparent")),
                            t && "object" == e(t))
                        )
                            for (var n in t) "+" == n.charAt(0) ? ((n = n.slice(1)), i.setAttribute(n, i.getAttribute(n) + t["+" + n])) : i.setAttribute(n, t[n]);
                    ...
                    value: function (t) {
                        ...
                        return (
                            ...
                            (i = Object.keys(t).filter(function (e) {
                                ...
                                ? i > 1 && console.warn("list editor config error - only one of the values, valuesURL, or valuesLookup options can be set on the same editor")
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        ("editor" == this.params.verticalNavigation || ("hybrid" == this.params.verticalNavigation && t)) &&
                            (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t > 0 && this._focusItem(this.displayItems[t - 1]));
                    },
                },
                {
                    key: "_keyDown",
                    ...
                    value: function (e) {
                        ...
                        return (
                            ...
                            this.params.values
                                ...
                                ? (i = this._ajaxRequest(this.params.valuesURL, this.input.value))
                                : "function" == typeof this.params.valuesLookup
                                ? (i = this.params.valuesLookup(this.cell, this.input.value))
                                : this.params.valuesLookup && (i = this._uniqueColumnValues(this.params.valuesLookupField)),
                ...
                },
                {
                    ...
                    value: function (e, t, i) {
                        ...
                        e.options
                            ...
                            : ((n = { label: e.label, value: e.value, itemParams: e.itemParams, elementAttributes: e.elementAttributes, element: !1, selected: !1, visible: !0, level: i, original: e }),
                              this.initialValues && this.initialValues.indexOf(e.value) > -1 && this._chooseItem(n, !0)),
                            t.push(n);
                    },
                },
                {
                    ...
                    value: function (e, t) {
                        var i = this,
                            n = { label: e.label, group: !0, itemParams: e.itemParams, elementAttributes: e.elementAttributes, element: !1, visible: !0, level: t, options: [], original: e };
                        return (
                    ...
                    value: function (e, t) {
                        ...
                        if (e || 0 === e) {
                            if (t || 0 === t) {
                                ...
                                for (i = i.match(l), n = n.match(l), r = i.length > n.length ? n.length : i.length; s < r; )
                                    if ((o = i[s]) !== (a = n[s++])) return isFinite(o) && isFinite(a) ? ("0" === o.charAt(0) && (o = "." + o), "0" === a.charAt(0) && (a = "." + a), o - a) : o > a ? 1 : -1;
                        ...
                        if (!this.filtered || t.visible) {
                            if (!o) {
                                if (
                                    ...
                                    (i = this.params.itemFormatter ? this.params.itemFormatter(t.label, t.value, t.original, o) : t.label) instanceof HTMLElement ? o.appendChild(i) : (o.innerHTML = i),
                                    t.group ? o.classList.add("tabulator-edit-list-group") : o.classList.add("tabulator-edit-list-item"),
                                    o.classList.add("tabulator-edit-list-group-level-" + t.level),
                                    t.elementAttributes && "object" == e(t.elementAttributes))
                                )
                                    for (var a in t.elementAttributes) "+" == a.charAt(0) ? ((a = a.slice(1)), o.setAttribute(a, this.input.getAttribute(a) + t.elementAttributes["+" + a])) : o.setAttribute(a, t.elementAttributes[a]);
                                t.group ? o.addEventListener("click", this._groupClick.bind(this, t)) : o.addEventListener("click", this._itemClick.bind(this, t)),
                            ...
                            this.params.multiselect
                                ? ((i = this.currentItems.indexOf(e)) > -1 ? (this.currentItems.splice(i, 1), (e.selected = !1)) : (this.currentItems.push(e), (e.selected = !0)),
                                  (this.input.value = this.currentItems
                                      ...
                                      .join(",")),
                                  this._styleItem(e))
                                : ((this.currentItems = [e]), (e.selected = !0), console.log("choose"), (this.input.value = e.label), this._styleItem(e), t || this._resolveValue()),
                            this._focusItem(e);
                    },
                },
                {
    ...
    var me = {
            input: function (t, i, n, o, a) {
                ...
                if ((s.setAttribute("type", a.search ? "search" : "text"), (s.style.padding = "4px"), (s.style.width = "100%"), (s.style.boxSizing = "border-box"), a.elementAttributes && "object" == e(a.elementAttributes)))
                    for (var l in a.elementAttributes) "+" == l.charAt(0) ? ((l = l.slice(1)), s.setAttribute(l, s.getAttribute(l) + a.elementAttributes["+" + l])) : s.setAttribute(l, a.elementAttributes[l]);
                function u(e) {
            ...
            textarea: function (t, i, n, o, a) {
                var r = t.getValue(),
                    ...
                    l = String(null != r ? r : ""),
                    u = ((l.match(/(?:\r\n|\r|\n)/g) || []).length, document.createElement("textarea")),
                    c = 0;
                if (
                    ...
                    for (var h in a.elementAttributes) "+" == h.charAt(0) ? ((h = h.slice(1)), u.setAttribute(h, u.getAttribute(h) + a.elementAttributes["+" + h])) : u.setAttribute(h, a.elementAttributes[h]);
                function d(e) {
            ...
            number: function (t, i, n, o, a) {
                ...
                if (
                    ...
                    for (var u in a.elementAttributes) "+" == u.charAt(0) ? ((u = u.slice(1)), l.setAttribute(u, l.getAttribute(u) + a.elementAttributes["+" + u])) : l.setAttribute(u, a.elementAttributes[u]);
                l.value = r;
                var c = function (e) {
                    h();
                };
            ...
            star: function (t, i, n, o, a) {
                ...
                if (
                    ...
                    for (var v in a.elementAttributes) "+" == v.charAt(0) ? ((v = v.slice(1)), d.setAttribute(v, d.getAttribute(v) + a.elementAttributes["+" + v])) : d.setAttribute(v, a.elementAttributes[v]);
            ...
            progress: function (t, i, n, o, a) {
                ...
                if (
                    ...
                    for (var g in a.elementAttributes) "+" == g.charAt(0) ? ((g = g.slice(1)), p.setAttribute(g, p.getAttribute(g) + a.elementAttributes["+" + g])) : p.setAttribute(g, a.elementAttributes[g]);
                return (
            ...
            tickCross: function (t, i, n, o, a) {
                ...
                if ((s.setAttribute("type", "checkbox"), (s.style.marginTop = "5px"), (s.style.boxSizing = "border-box"), a.elementAttributes && "object" == e(a.elementAttributes)))
                    for (var m in a.elementAttributes) "+" == m.charAt(0) ? ((m = m.slice(1)), s.setAttribute(m, s.getAttribute(m) + a.elementAttributes["+" + m])) : s.setAttribute(m, a.elementAttributes[m]);
                function p(e) {
                    var t = s.checked;
                ...
                return (
                    (s.value = r),
                    !l || (void 0 !== r && r !== u && "" !== r) || ((c = !0), (s.indeterminate = !0)),
                    "firefox" != this.table.browser &&
                        i(function () {
                            s.focus({ preventScroll: !0 });
                        }),
                    (s.checked = h ? r === a.trueValue : !0 === r || "true" === r || "True" === r || 1 === r),
                    i(function () {
                        s.focus();
                    }),
        ...
        pe = (function (i) {
            ...
            function r(e) {
                ...
                return (
                    ...
                    i.registerTableFunction("getEditedCells", i.getEditedCells.bind(l(i))),
                    i.registerTableFunction("clearCellEdited", i.clearCellEdited.bind(l(i))),
                    ...
                    i.registerComponentFunction("cell", "isEdited", i.cellisEdited.bind(l(i))),
                    i.registerComponentFunction("cell", "clearEdited", i.clearEdited.bind(l(i))),
                    i.registerComponentFunction("cell", "edit", i.editCell.bind(l(i))),
                    i.registerComponentFunction("cell", "cancelEdit", i.cellCancelEdit.bind(l(i))),
                    i.registerComponentFunction("cell", "navigatePrev", i.navigatePrev.bind(l(i))),
                    i.registerComponentFunction("cell", "navigateNext", i.navigateNext.bind(l(i))),
                    i.registerComponentFunction("cell", "navigateLeft", i.navigateLeft.bind(l(i))),
                    i.registerComponentFunction("cell", "navigateRight", i.navigateRight.bind(l(i))),
                    i.registerComponentFunction("cell", "navigateUp", i.navigateUp.bind(l(i))),
                    i.registerComponentFunction("cell", "navigateDown", i.navigateDown.bind(l(i))),
                    i
                );
            }
            return (
                o(r, [
                            ...
                            t &&
                                (this.navigateNext(t, e) ||
                                    (i &&
                                        ...
                                        (i = !0 === i ? this.table.addRow({}) : "function" == typeof i ? this.table.addRow(i(t.row.getComponent())) : this.table.addRow(Object.assign({}, i))).then(function () {
                                            setTimeout(function () {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e,
                                t,
                                i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.currentCell,
                    ...
                    },
                    {
                        key: "initializeColumn",
                        value: function (t) {
                            var i = { editor: !1, blocked: !1, check: t.definition.editable, params: t.definition.editorParams || {} };
                        ...
                        value: function (e) {
                            if ("virtual" == this.table.rowManager.getRenderMode()) {
                                ...
                                var o = this.table.rowManager.element.scrollLeft,
                                    ...
                                    r = e.getElement();
                                r.offsetLeft;
                                this.table.modExists("frozenColumns") && ((o += parseInt(this.table.modules.frozenColumns.leftMargin)), (a -= parseInt(this.table.modules.frozenColumns.rightMargin))),
                                    "virtual" === this.table.options.renderHorizontal && ((o -= parseInt(this.table.columnManager.renderer.vDomPadLeft)), (a -= parseInt(this.table.columnManager.renderer.vDomPadLeft))),
                            ...
                            if (!this.currentCell) {
                                ...
                                if (l || n) {
                                    if (
                                        ...
                                        (a = t.getComponent()),
                                        this.mouseClick && ((this.mouseClick = !1), t.column.definition.cellClick && t.column.definition.cellClick.call(this.table, i, a)),
                                        t.column.definition.cellEditing && t.column.definition.cellEditing.call(this.table, a),
                                        this.dispatch("cell-editing", t),
                                        this.dispatchExternal("cellEditing", a),
                                        (r = "function" == typeof t.column.modules.edit.params ? t.column.modules.edit.params(a) : t.column.modules.edit.params),
                                        !1 ===
                                            (o = t.column.modules.edit.editor.call(
                                                ...
                                                function (e) {
                                                    if (s.currentCell === t) {
                                                        ...
                                                        return !0 === i || "highlight" === s.table.options.validationMode
                                                            ? (s.clearEditor(), t.modules.edit || (t.modules.edit = {}), (t.modules.edit.edited = !0), -1 == s.editedCells.indexOf(t) && s.editedCells.push(t), t.setValue(e, !0), !0 === i)
                                                            : ((s.invalidEdit = !0), s.focusCellNoEvent(t, !0), u(), !1);
                                                    }
                                                },
                                                function () {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this,
                                t = [];
                            return (
                                (!1 !== this.config.columnGroups ? this.table.columnManager.columns : this.table.columnManager.columnsByIndex).forEach(function (i) {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            var t = this,
                                i = e.columns,
                                n = 0,
                                o = { title: e.definition["title" + (this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1))] || e.definition.title, column: e, depth: 1 };
                            if (i.length) {
                                if (
                                    ((o.subGroups = []),
                                    (o.width = 0),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            var t = this,
                                ...
                                s = {};
                            return (
                                (s.rowFormatter = null !== r ? r : this.table.options.rowFormatter),
                                this.table.options.dataTree && !1 !== this.config.dataTree && this.table.modExists("columnCalcs") && (s.treeElementField = this.table.modules.dataTree.elementField),
                                (s.groupHeader = this.table.options["groupHeader" + (this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1))]),
                                s.groupHeader && !Array.isArray(s.groupHeader) && (s.groupHeader = [s.groupHeader]),
                                i.classList.add("tabulator-print-table"),
                                this.mapElementStyles(this.table.columnManager.getHeadersElement(), n, ["border-top", "border-left", "border-right", "border-bottom", "background-color", "color", "font-weight", "font-family", "font-size"]),
                                ...
                                e.forEach(function (e, i) {
                                    switch (e.type) {
                                        ...
                                        case "row":
                                            ...
                                            t.mapElementStyles(i % 2 && a.evenRow ? a.evenRow : a.oddRow, r, [
                                                "border-top",
                                                "border-left",
                                                "border-right",
                                                "border-bottom",
                                ...
                                i.appendChild(o),
                                this.mapElementStyles(this.table.element, i, ["border-top", "border-left", "border-right", "border-bottom"]),
                                i
                            );
                        },
                    },
                                ...
                                e.columns.forEach(function (e) {
                                    if (e) {
                                        ...
                                        (t.colSpan = e.width),
                                            ...
                                            n.mapElementStyles(e.component._column.contentElement, t, ["padding-top", "padding-left", "padding-right", "padding-bottom"]),
                                            e.component._column.visible ? n.mapElementStyles(e.component.getElement(), t, ["width"]) : e.component._column.definition.width && (t.style.width = e.component._column.definition.width + "px"),
                                            e.component._column.parent && n.mapElementStyles(e.component._column.parent.groupElement, t, ["border-top"]),
                                            o.appendChild(t);
                                    }
                                }),
                                o
                        ...
                        value: function (e, t, i) {
                            ...
                            return (
                                ...
                                t.groupHeader && t.groupHeader[e.indent]
                                    ? (a.value = t.groupHeader[e.indent](a.value, e.component._group.getRowCount(), e.component._group.getData(), e.component))
                                    : !1 === t.groupHeader
                                    ? (a.value = a.value)
                                    : (a.value = e.component._group.generator(a.value, e.component._group.getRowCount(), e.component._group.getData(), e.component)),
                                (o.colSpan = a.width),
                                (o.innerHTML = a.value),
                                n.classList.add("tabulator-print-table-group"),
                                n.classList.add("tabulator-group-level-" + e.indent),
                                a.component.isVisible() && n.classList.add("tabulator-group-visible"),
                                this.mapElementStyles(i.firstGroup, n, ["border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "background-color"]),
                    ...
                    },
                    {
                        ...
                        value: function (e, t, i) {
                            ...
                            return (
                                ...
                                this.mapElementStyles(i.calcRow, n, ["border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "background-color"]),
                                n
                            );
                        },
                    },
                            ...
                            return (
                                ...
                                t.columns.forEach(function (s) {
                                    if (s) {
                                        ...
                                        if (
                                            ((u.definition.cssClass ? u.definition.cssClass.split(" ") : []).forEach(function (e) {
                                                l.classList.add(e);
                                            }),
                                            a.table.modExists("format") && !1 !== a.config.formatCells)
                                        )
                                            h = a.table.modules.format.formatExportValue(d, a.colVisProp);
                                        else
                                            switch (e(h)) {
                                                case "object":
                                        ...
                                        h instanceof Node ? l.appendChild(h) : (l.innerHTML = h),
                                            (o.styleCells[c] || o.firstCell) &&
                                                ...
                                                u.definition.align && (l.style.textAlign = u.definition.align)),
                                            a.table.options.dataTree &&
                                                !1 !== a.config.dataTree &&
                                                ((n.treeElementField && n.treeElementField == u.field) || (!n.treeElementField && 0 == i)) &&
                                                (t.component._row.modules.dataTree.controlEl && l.insertBefore(t.component._row.modules.dataTree.controlEl.cloneNode(!0), l.firstChild),
                                                t.component._row.modules.dataTree.branchEl && l.insertBefore(t.component._row.modules.dataTree.branchEl.cloneNode(!0), l.firstChild)),
                                            r.appendChild(l),
                                            d.modules.format && d.modules.format.renderedCallback && d.modules.format.renderedCallback(),
                                            n.rowFormatter && !1 !== a.config.formatCells && n.rowFormatter(t.component);
                                    }
                                }),
                                r
                            );
        ...
        ye = (function (i) {
            ...
            function r(e) {
                ...
                return (
                    ...
                    i.registerTableFunction("refreshFilter", i.userRefreshFilter.bind(l(i))),
                    i.registerTableFunction("addFilter", i.userAddFilter.bind(l(i))),
                    i.registerTableFunction("getFilters", i.getFilters.bind(l(i))),
                    i.registerTableFunction("setHeaderFilterFocus", i.userSetHeaderFilterFocus.bind(l(i))),
                    i.registerTableFunction("getHeaderFilterValue", i.userGetHeaderFilterValue.bind(l(i))),
                    i.registerTableFunction("setHeaderFilterValue", i.userSetHeaderFilterValue.bind(l(i))),
                    i.registerTableFunction("getHeaderFilters", i.getHeaderFilters.bind(l(i))),
                    i.registerTableFunction("removeFilter", i.userRemoveFilter.bind(l(i))),
                    i.registerTableFunction("clearFilter", i.userClearFilter.bind(l(i))),
                    i.registerTableFunction("clearHeaderFilter", i.userClearHeaderFilter.bind(l(i))),
                    i.registerComponentFunction("column", "headerFilterFocus", i.setHeaderFilterFocus.bind(l(i))),
                    i.registerComponentFunction("column", "reloadHeaderFilter", i.reloadHeaderFilter.bind(l(i))),
                    i.registerComponentFunction("column", "getHeaderFilterValue", i.getHeaderFilterValue.bind(l(i))),
                    i.registerComponentFunction("column", "setHeaderFilterValue", i.setHeaderFilterValue.bind(l(i))),
                    i
                );
            }
            return (
                o(r, [
                            ...
                            (t.modules.filter = {
                                success: function (i) {
                                    ...
                                    if (void 0 === t.modules.filter.prevSuccess || t.modules.filter.prevSuccess !== i) {
                                        if (((t.modules.filter.prevSuccess = i), t.modules.filter.emptyFunc(i))) delete n.headerFilters[o];
                                        else {
                        ...
                        value: function (t, i, n) {
                            ...
                            if (((t.modules.filter.value = i), t.modules.filter.headerElement && t.modules.filter.headerElement.parentNode && t.contentElement.removeChild(t.modules.filter.headerElement.parentNode), p)) {
                                switch (
                                    ...
                                    (o = document.createElement("div")).classList.add("tabulator-header-filter"),
                                    e(t.definition.headerFilter))
                                ) {
                                    case "string":
                                        d.table.modules.edit.editors[t.definition.headerFilter]
                                            ? ((a = d.table.modules.edit.editors[t.definition.headerFilter]),
                                    ...
                                    case "boolean":
                                        t.modules.edit && t.modules.edit.editor
                                            ...
                                            ? ((a = d.table.modules.edit.editors[t.definition.formatter]),
                                ...
                                if (a) {
                                    if (
                                        ...
                                        (c = "function" == typeof (c = t.definition.headerFilterParams || {}) ? c.call(d.table, s) : c),
                                        !(r = a.call(
                                    ...
                                    p
                                        ...
                                        (t.modules.filter.attrType = r.hasAttribute("type") ? r.getAttribute("type").toLowerCase() : ""),
                                        ...
                                        !1 !== t.definition.headerFilterLiveFilter &&
                                            ("autocomplete" !== t.definition.headerFilter &&
                                                ...
                                                "text" == t.modules.filter.attrType && "ie" !== this.table.browser && r.setAttribute("type", "search")),
                    ...
                    },
                    {
                        ...
                        value: function (e, t, i, n) {
                            var o = this,
                                a = !1;
                            Array.isArray(e) || (e = [{ field: e, type: t, value: i, params: n }]),
                                e.forEach(function (e) {
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            return (
                                e.forEach(function (e) {
                                    var o;
                                    Array.isArray(e) ? n.push(i.filtersToArray(e, t)) : ((o = { field: e.field, type: e.type, value: e.value }), t && "function" == typeof o.type && (o.type = "function"), n.push(o));
                                }),
                                n
                            );
                        },
                        ...
                        value: function (e, t) {
                            ...
                            return (
                                ...
                                this.subscribedExternal("dataFiltered") &&
                                    ...
                                    this.dispatchExternal("dataFiltered", this.getFilters(!0), o)),
                                n
                            );
                        },
                    },
    ...
    var we = {
            ...
            money: function (e, t, i) {
                ...
                if ((s < 0 && ((s = Math.abs(s)), (l = h)), (n = !1 !== p ? s.toFixed(p) : s), (o = (n = String(n).split("."))[0]), (a = n.length > 1 ? u + n[1] : ""), !1 !== t.thousand))
            ...
            link: function (t, i, n) {
                ...
                if (
                    (i.labelField &&
                        ...
                        })(i.labelField.split(this.table.options.nestedFieldSeparator), o))),
                    i.label)
                )
                    switch (e(i.label)) {
                        case "string":
                ...
                if (l) {
                    ...
                    return (
                        ...
                        i.download && ((s = "function" == typeof s ? s(t) : !0 === s ? "" : s), u.setAttribute("download", s)),
            ...
            tickCross: function (e, t, i) {
                ...
                return (s && n === t.trueValue) || (!s && ((r && n) || !0 === n || "true" === n || "True" === n || 1 === n || "1" === n))
            ...
            datetime: function (e, t, i) {
                var n,
                    ...
                    l = e.getValue();
                if (void 0 !== o)
                    return (n = o.isDateTime(l) ? l : "iso" === a ? o.fromISO(String(l)) : o.fromFormat(String(l), a)).isValid
            ...
            datetimediff: function (e, t, i) {
                var n,
                    ...
                    h = e.getValue();
                if (void 0 !== o)
                    return (n = o.isDateTime(h) ? h : "iso" === a ? o.fromISO(String(h)) : o.fromFormat(String(h), a)).isValid
                        ? u
            ...
            rowSelection: function (e, t, i) {
                var n = this,
                    ...
                    a = !1;
                if (((o.type = "checkbox"), o.setAttribute("aria-label", "Select Row"), this.table.modExists("selectRow", !0)))
                    if (
            ...
            return (
                o(r, [
                    ...
                    },
                    {
                        key: "lookupFormatter",
                        value: function (t, i) {
                            var n = { params: t.definition["formatter" + i + "Params"] || {} },
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            if (n) {
                                return (
                                    (i = "function" == typeof n.params ? n.params(component) : n.params),
        ...
        return (
            o(n, [
                    ...
                    value: function (e) {
                        ...
                        (this.table.columnManager.headersElement.style.marginLeft = this.leftMargin),
                            ...
                            this.leftColumns.forEach(function (o, a) {
                                if (
                                    ((o.modules.frozen.marginValue = n + t.table.columnManager.scrollLeft),
                                    (o.modules.frozen.margin = o.modules.frozen.marginValue + "px"),
                                    o.visible && (n += o.getWidth()),
                                    a == t.leftColumns.length - 1 ? (o.modules.frozen.edge = !0) : (o.modules.frozen.edge = !1),
                                    o.parent.isGroup)
                                ) {
                            ...
                            this.rightColumns.forEach(function (i, n) {
                                i.visible && (o += i.getWidth()),
                                    ...
                                    (i.modules.frozen.margin = i.modules.frozen.marginValue + "px"),
                                    n == t.rightColumns.length - 1 ? (i.modules.frozen.edge = !0) : (i.modules.frozen.edge = !1),
                                    i.parent.isGroup ? t.layoutElement(t.getColGroupParentElement(i), i) : t.layoutElement(i.getElement(), i),
                                    e &&
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        t.modules.frozen &&
                            ((e.style.position = "absolute"), (e.style.left = t.modules.frozen.margin), e.classList.add("tabulator-frozen"), t.modules.frozen.edge && e.classList.add("tabulator-frozen-" + t.modules.frozen.position));
                    },
                },
                {
                    key: "_calcSpace",
    ...
    var Ee = (function (e) {
        ...
        function n(e) {
            ...
            return (
                ...
                o.registerComponentFunction("row", "unfreeze", o.unfreezeRow.bind(l(o))),
                o.registerComponentFunction("row", "isFrozen", o.isRowFrozen.bind(l(o))),
                o
            );
        }
        return (
        ...
        xe = (function () {
            function e(i, n, o, a, r, s, l) {
                t(this, e),
                    ...
                    (this.modules = {}),
                    (this.arrowElement = !1),
                    (this.visible = l ? l.visible : void 0 !== i.startOpen[o] ? i.startOpen[o] : i.startOpen[0]),
                    (this.component = null),
                    this.createElements(),
                    this.addBindings(),
            ...
            return (
                o(e, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.groupManager.table.options.groupToggleElement &&
                                ("arrow" == this.groupManager.table.options.groupToggleElement ? this.arrowElement : this.element).addEventListener("click", function (t) {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            var t,
                                i = e.level + "_" + e.key;
                            this.groups[i] &&
                                (delete this.groups[i], (t = this.groupList.indexOf(e)) > -1 && this.groupList.splice(t, 1), this.groupList.length || (this.parent ? this.parent.removeGroup(this) : this.groupManager.removeGroup(this)));
                        },
                    },
                    {
                    ...
                    },
                    {
                        key: "show",
                        value: function () {
                            if (((this.visible = !0), "classic" != this.groupManager.table.rowManager.getRenderMode() || this.groupManager.table.options.pagination)) this.groupManager.updateGroupRows(!0);
                            else {
        ...
        Te = (function (e) {
            ...
            function n(e) {
                ...
                return (
                    ...
                    o.registerTableFunction("setGroupValues", o.setGroupValues.bind(l(o))),
                    o.registerTableFunction("setGroupStartOpen", o.setGroupStartOpen.bind(l(o))),
                    o.registerTableFunction("setGroupHeader", o.setGroupHeader.bind(l(o))),
                    o.registerTableFunction("getGroups", o.userGetGroups.bind(l(o))),
                    o.registerTableFunction("getGroupedData", o.userGetGroupedData.bind(l(o))),
                    o.registerComponentFunction("row", "getGroup", o.rowGetGroup.bind(l(o))),
                    o
                );
            }
            return (
                        ...
                        value: function () {
                            ...
                            if (this.table.options.groupBy) {
                                ...
                                if (
                                    ...
                                    Array.isArray(t) && Array.isArray(n) && t.length > n.length && console.warn("Error creating group headers, groupHeader array is shorter than groupBy array"),
                                ...
                                Array.isArray(t) || (t = [t]),
                                    t.forEach(function (t, i) {
                                        ...
                                        (n =
                                            ...
                                            e.groupIDLookups.push({ field: "function" != typeof t && t, func: n, values: !!e.allowedValues && e.allowedValues[i] });
                                    }),
                                    i && (Array.isArray(i) || (i = [i]), i.forEach(function (e) {}), (this.startOpen = i)),
                        ...
                        value: function (e, t, i) {
                            ...
                            return (
                                n.length > 1 &&
                                    (!t || (t && -1 == n.indexOf(t))
                                        ? i
                                            ? n[0] !== e && ((t = n[0]), this.table.rowManager.moveRowInArray(e.modules.group.rows, e, t, !i))
                                            : n[n.length - 1] !== e && ((t = n[n.length - 1]), this.table.rowManager.moveRowInArray(e.modules.group.rows, e, t, !i))
                                ...
                                e.forEach(function (e) {
                                    ...
                                    e.hasSubGroups
                                        ? ((o = t.pullGroupListData(e.groupList)),
                                          ...
                                          (n.headerContent = e.generator(e.key, n.rowCount, e.rows, e)),
                                          i.push(n),
                                          (i = i.concat(o)))
                                        : ((n.level = e.level),
                                          (n.headerContent = e.generator(e.key, e.rows.length, e.rows, e)),
        ...
        return (
            o(n, [
                ...
                },
                {
                    key: "rowMoved",
                    value: function (e, t, i) {
                        this.action("rowMove", e, { posFrom: this.table.rowManager.getRowPosition(e), posTo: this.table.rowManager.getRowPosition(t), to: t, after: i });
                    },
                },
                {
                    key: "rowAdded",
                ...
                },
                {
                    ...
                    value: function (e) {
                        var t, i;
                        this.table.options.groupBy ? (t = (i = e.getComponent().getGroup().rows).indexOf(e)) && (t = i[t - 1]) : (t = e.table.rowManager.getRowIndex(e)) && (t = e.table.rowManager.rows[t - 1]),
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        this.history.forEach(function (i) {
                            if (i.component instanceof D) i.component === e && (i.component = t);
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        if (!this.table.modExists("edit") || this.table.modules.edit.currentCell !== this) {
                            e.preventDefault();
                            try {
                                if (document.selection) (i = document.body.createTextRange()).moveToElementText(this.element), i.select();
                        ...
                        switch (("column" === e && (e = "header"), t)) {
                            ...
                            case "end":
                                a.tap && ((a.tap = null), this.dispatchEvent(e + "Tap", i, n)),
                                    a.tapDbl
                                        ? (clearTimeout(a.tapDbl), (a.tapDbl = null), this.dispatchEvent(e + "DblTap", i, n))
        ...
        return (
            o(r, [
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        var i = this,
                            n = { action: r.actions[e], keys: [], ctrl: !1, shift: !1, meta: !1 };
                        t.toString()
                            .toLowerCase()
                            .split(" ")
                            .join("")
                ...
                },
                {
                    ...
                    value: function () {
                        void 0 !== this.table.options.menuContainer &&
                            (console.warn("Use of the menuContainer option is now deprecated. Please use the popupContainer option instead"), (this.table.options.popupContainer = this.table.options.menuContainer));
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        (t = document.createElement("span")).classList.add("tabulator-header-popup-button"),
                            n ? ("function" == typeof n && (n = n(e.getComponent())), n instanceof HTMLElement ? t.appendChild(n) : (t.innerHTML = n)) : (t.innerHTML = "&vellip;"),
                            t.addEventListener("click", function (t) {
                            ...
                            i.forEach(function (e) {
                                ...
                                e.separator
                                    ...
                                    : (i.classList.add("tabulator-menu-item"),
                                      "function" == typeof n && (n = n.call(r.table, t.getComponent())),
                                      n instanceof Node ? i.appendChild(n) : (i.innerHTML = n),
                                      "function" == typeof o && (o = o.call(r.table, t.getComponent())),
                                      o
    ...
    var He = (function (e) {
        ...
        function n(e) {
            ...
            return (
                t(this, n),
                ((o = i.call(this, e)).placeholderElement = o.createPlaceholderElement()),
                (o.hoverElement = !1),
                (o.checkTimeout = !1),
                (o.checkPeriod = 250),
                (o.moving = !1),
            ...
            o(n, [
                        ...
                        e.modules.frozen ||
                            ...
                            (n.mousemove = function (n) {
                                e.parent === i.moving.parent &&
                                    ((i.touchMove ? n.touches[0].pageX : n.pageX) - k.elOffset(t).left + i.table.columnManager.element.scrollLeft > e.getWidth() / 2
                                ...
                                function (l) {
                                    ...
                                    s.moving &&
                                        ...
                                        (c = l.touches[0].pageX - u) > 0
                                            ? t && c - a > n && (h = t) !== e && ((u = l.touches[0].pageX), h.getElement().parentNode.insertBefore(s.placeholderElement, h.getElement().nextSibling), s.moveColumn(h, !0))
                                            : i && -c - r > o && (h = i) !== e && ((u = l.touches[0].pageX), h.getElement().parentNode.insertBefore(s.placeholderElement, h.getElement()), s.moveColumn(h, !1)),
                                        h && ((t = h.nextColumn()), (a = n), (n = t ? t.getWidth() / 2 : 0), (i = h.prevColumn()), (r = o), (o = i ? i.getWidth() / 2 : 0)));
                                },
                                { passive: !0 }
                            ),
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        ...
                        (this.moving = t),
                            (this.startX = (this.touchMove ? e.touches[0].pageX : e.pageX) - k.elOffset(i).left),
                            ...
                            (this.hoverElement.style.bottom = n.clientHeight - o.offsetHeight + "px"),
    ...
    var _e = (function (i) {
        ...
        function r(e) {
            ...
            return (
                t(this, r),
                ((i = n.call(this, e)).placeholderElement = i.createPlaceholderElement()),
                (i.hoverElement = !1),
                (i.checkTimeout = !1),
                (i.checkPeriod = 150),
                (i.moving = !1),
            ...
            o(r, [
                    ...
                    value: function (e) {
                        ...
                        (i.mouseup = function (e) {
                            ...
                            (i.mousemove = function (i) {
                                var n;
                                i.pageY - k.elOffset(e.element).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2
                                    ? (t.toRow === e && t.toRowAfter) || ((n = e.getElement()).parentNode.insertBefore(t.placeholderElement, n.nextSibling), t.moveRow(e, !0))
                                    : (t.toRow !== e || t.toRowAfter) && (n = e.getElement()).previousSibling && (n.parentNode.insertBefore(t.placeholderElement, n), t.moveRow(e, !1));
                            }.bind(t)),
                            (e.modules.moveRow = i);
                    },
                },
                    ...
                    value: function (e) {
                        ...
                        (n.mouseup = function (t) {
                            ...
                            (n.mousemove = function (t) {
                                var n = e.getElement();
                                t.pageY - k.elOffset(n).top + i.table.rowManager.element.scrollTop > e.getHeight() / 2
                                    ? (i.toRow === e && i.toRowAfter) || (n.parentNode.insertBefore(i.placeholderElement, n.nextSibling), i.moveRow(e, !0))
                                    : (i.toRow !== e || i.toRowAfter) && (n.parentNode.insertBefore(i.placeholderElement, n), i.moveRow(e, !1));
                            }.bind(i)),
                            this.hasHandle ||
                            ...
                            t.addEventListener("touchmove", function (t) {
                                ...
                                l.moving &&
                                    ...
                                    (c = t.touches[0].pageY - u) > 0
                                        ? i && c - r > o && (h = i) !== e && ((u = t.touches[0].pageY), h.getElement().parentNode.insertBefore(l.placeholderElement, h.getElement().nextSibling), l.moveRow(h, !0))
                                        : n && -c - s > a && (h = n) !== e && ((u = t.touches[0].pageY), h.getElement().parentNode.insertBefore(l.placeholderElement, h.getElement()), l.moveRow(h, !1)),
                                    h && ((i = h.nextRow()), (r = o), (o = i ? i.getHeight() / 2 : 0), (n = h.prevRow()), (s = a), (a = n ? n.getHeight() / 2 : 0)));
                            }),
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        ...
                        (i = t.getElement()),
                            this.connection ? ((n = i.getBoundingClientRect()), (this.startX = n.left - o + window.pageXOffset), (this.startY = n.top - a + window.pageYOffset)) : (this.startY = a - i.getBoundingClientRect().top);
                    },
                },
                {
                    key: "endMove",
                ...
                },
                {
                    ...
                    value: function () {
                        var e;
                        this.connectionSelectorsTables &&
                            ((e = this.commsConnections(this.connectionSelectorsTables)), this.dispatchExternal("movableRowsSendingStop", e), this.commsSend(this.connectionSelectorsTables, "moveRow", "disconnect")),
                            this.connectionElements.forEach(function (e) {
                ...
                },
                {
                    ...
                    value: function (t, i, n) {
                        ...
                        if (n) {
                            ...
                            o
                                ? o.call(this, this.moving.getComponent(), i ? i.getComponent() : void 0, t)
                                ...
                                this.dispatchExternal("movableRowsSent", this.moving.getComponent(), i ? i.getComponent() : void 0, t);
                ...
                },
                {
                    ...
                    value: function (t, i) {
                        ...
                        n ? (o = n.call(this, this.connectedRow.getComponent(), i ? i.getComponent() : void 0, this.connectedTable)) : console.warn("Mover Row Error - no matching receiver found:", this.table.options.movableRowsReceiver),
                            o
                                ? this.dispatchExternal("movableRowsReceived", this.connectedRow.getComponent(), i ? i.getComponent() : void 0, this.connectedTable)
                                : this.dispatchExternal("movableRowsReceivedFailed", this.connectedRow.getComponent(), i ? i.getComponent() : void 0, this.connectedTable),
                            this.commsSend(this.connectedTable, "moveRow", "dropcomplete", { row: i, success: o });
                    },
                },
                {
                    key: "commsReceived",
    ...
    var Oe = (function (i) {
        ...
        function r(e) {
            ...
            return (
                t(this, r),
                ((i = n.call(this, e)).allowedTypes = ["", "data", "edit", "clipboard"]),
                (i.enabled = !0),
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        this.allowedTypes.forEach(function (o) {
                            ...
                            e.definition[r] && (a = t.lookupMutator(e.definition[r])) && ((i = !0), (n[r] = { mutator: a, params: e.definition[r + "Params"] || {} }));
                        }),
                        ...
                        return (
                            this.enabled &&
                                this.table.columnManager.traverse(function (a) {
                                    var r, s, l;
                                    a.modules.mutate &&
                                        (r = a.modules.mutate[o] || a.modules.mutate.mutator || !1) &&
                                        ((n = a.getFieldValue(void 0 !== i ? i : e)),
                                        ("data" != t && void 0 === n) || ((l = a.getComponent()), (s = "function" == typeof r.params ? r.params(n, e, t, l) : r.params), a.setFieldValue(e, r.mutator(n, e, t, s, l))));
                                }),
                            e
                        );
                    },
    ...
    var Ae = {
            rows: function (e, t, i, n, o) {
                ...
                return (
                    this.table.modules.localize.langBind("pagination|counter|showing", function (e) {
                        r.innerHTML = e;
                    }),
                    ...
                    n
                        ? ((s.innerHTML = " " + t + "-" + Math.min(t + e - 1, n) + " "), (u.innerHTML = " " + n + " "), a.appendChild(r), a.appendChild(s), a.appendChild(l), a.appendChild(u), a.appendChild(c))
                        : ((s.innerHTML = " 0 "), a.appendChild(r), a.appendChild(s), a.appendChild(c)),
                    a
                );
            },
            pages: function (e, t, i, n, o) {
                ...
                return (
                    ...
                    (u.innerHTML = " " + o + " "),
                    this.table.modules.localize.langBind("pagination|counter|pages", function (e) {
                        c.innerHTML = e;
                    }),
                    a.appendChild(r),
                    a.appendChild(s),
        ...
        Be = (function (i) {
            ...
            function r(e) {
                ...
                return (
                    ...
                    i.registerTableFunction("setPageToRow", i.userSetPageToRow.bind(l(i))),
                    ...
                    i.registerComponentFunction("row", "pageTo", i.setPageToRow.bind(l(i))),
                    i
                );
            }
            return (
                o(r, [
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            var i,
                                ...
                                o = n.getDisplayRows();
                            return t ? (o.length ? (i = o[0]) : n.activeRows.length && ((i = n.activeRows[n.activeRows.length - 1]), (t = !1))) : o.length && ((i = o[o.length - 1]), (t = !(o.length < this.size))), { index: i, top: t };
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            t ||
                                ...
                                ((i = this.table.rowManager.getElement()).scrollHeight - i.clientHeight - e < (this.table.options.progressiveLoadScrollMargin || 2 * i.clientHeight) && this.nextPage().catch(function () {}));
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, i, n) {
                            var o;
                            if (this.pageCounter)
                                switch (("remote" === this.mode && ((i = this.size), (n = (this.page - 1) * this.size + 1), (t = this.remoteRowCountEstimate)), e((o = this.pageCounter.call(this, i, n, this.page, t, this.max))))) {
                                    case "object":
                                        if (o instanceof Node) {
                                            ...
                                            (this.pageCounterElement.innerHTML = ""),
                                                null != o && console.warn("Page Counter Error - Page Counter has returned a type of object, the only valid page counter object return is an instance of Node, the page counter returned:", o);
                                        break;
                                    case "undefined":
                                        this.pageCounterElement.innerHTML = "";
                                        break;
                        ...
                        value: function () {
                            for (
                                var e = Math.floor((this.count - 1) / 2),
                                    ...
                                    n = this.page <= t ? Math.min(this.count, this.max) : Math.min(this.page + t, this.max);
                                ...
                                (this.mode = !0 !== t ? t : this.localStorageTest() ? "local" : "cookie"),
                                    this.table.options.persistenceReaderFunc
                                        ? "function" == typeof this.table.options.persistenceReaderFunc
                                            ...
                                            ? (this.readFunc = n.readers[this.table.options.persistenceReaderFunc])
                                    ...
                                    this.table.options.persistenceWriterFunc
                                        ? "function" == typeof this.table.options.persistenceWriterFunc
                                            ...
                                            ? (this.writeFunc = n.writers[this.table.options.persistenceWriterFunc])
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            this.config.columns &&
                                ...
                                (t = e.getDefinition()),
                                (!0 === this.config.columns ? Object.keys(t) : this.config.columns).forEach(function (e) {
                            ...
                            return (
                                (t = t || []).forEach(function (t, o) {
                                    var a,
                                        r = i._findColumn(e, t);
                                    r &&
                                        (!0 === i.config.columns || null == i.config.columns ? (a = Object.keys(r)).push("width") : (a = i.config.columns),
                                        a.forEach(function (e) {
                                            "columns" !== e && void 0 !== t[e] && (r[e] = t[e]);
                                        }),
                                        r.columns && (r.columns = i.mergeDefinition(r.columns, t.columns)),
                                        n.push(r));
                                }),
                            ...
                            return (
                                e.forEach(function (e) {
                                    var o,
                                        ...
                                        r = e.getDefinition();
                                    e.isGroup
                                        ? ((a.title = r.title), (a.columns = t.parseColumns(e.getColumns())))
                                        : ((a.field = e.getField()),
                                          !0 === t.config.columns || null == t.config.columns ? ((o = Object.keys(r)).push("width"), o.push("visible")) : (o = t.config.columns),
                ...
                },
                {
                    ...
                    value: function (e, t, i, n) {
                        var o,
                            ...
                            r = this,
                            s = !(e instanceof MouseEvent);
                        i instanceof HTMLElement ? (o = i) : ((o = document.createElement("div")).innerHTML = i),
                    ...
                    value: function (e, t, i) {
                        ...
                        (this.manualBlock = !0),
                            ...
                            this.table.options.printHeader &&
                                ...
                                "string" == typeof (n = "function" == typeof this.table.options.printHeader ? this.table.options.printHeader.call(this.table) : this.table.options.printHeader) ? (s.innerHTML = n) : s.appendChild(n),
                            ...
                            this.table.options.printFormatter && this.table.options.printFormatter(this.element, u),
                            window.print(),
                            this.cleanup(),
                            window.scrollTo(a, r),
                            (this.manualBlock = !1);
                            ...
                            Object.defineProperty(this.data, "splice", {
                                ...
                                value: function () {
                                    ...
                                    if (!i.blocked && t === i.currentVersion) {
                                        if (
                                            (s &&
                                                ((n = !!e[a] && i.table.rowManager.getRowFromDataObject(e[a]))
                                                    ? s.forEach(function (e) {
                    ...
                    value: function (e) {
                        ...
                        e.modules.frozen &&
                            (this.table.modules.frozenColumns.leftColumns.includes(e)
                                ? this.table.modules.frozenColumns.leftColumns.forEach(function (e) {
                                      t.reinitializeColumn(e);
                                  })
                                : this.table.modules.frozenColumns.rightColumns.includes(e) &&
                                  this.table.modules.frozenColumns.rightColumns.forEach(function (e) {
                                      t.reinitializeColumn(e);
                                  }));
                    },
                },
                    ...
                    value: function (e, t, i, n) {
                        ...
                        if (("header" === e && (r = { variableHeight: "textarea" == i.definition.formatter || i.definition.variableHeight }), (!0 === a || a == e) && this._checkResizability(s))) {
                            ...
                            l.addEventListener("mousedown", u),
                                ...
                                i.modules.frozen && ((l.style.position = "absolute"), (l.style.left = i.modules.frozen.marginValue + i.getWidth() + "px")),
                                (r.handleEl = l),
                    ...
                    value: function (e, t, i) {
                        ...
                        function o(e) {
                            ...
                            if (
                                ...
                                n.table.options.resizableColumnFit && n.nextColumn && (!i || !o))
                            ) {
                        ...
                        function a(e) {
                            n.startColumn.modules.edit && (n.startColumn.modules.edit.blocked = !1),
                                n.table.browserSlow && t.modules.resize && t.modules.resize.variableHeight && t.checkCellHeights(),
                                ...
                                n.startWidth !== t.getWidth() && (n.dispatch("column-resized", t), n.table.externalEvents.dispatch("columnResized", t.getComponent()));
                        }
                        n.table.element.classList.add("tabulator-block-select"),
                            e.stopPropagation(),
                            n.startColumn.modules.edit && (n.startColumn.modules.edit.blocked = !0),
                            (n.startX = void 0 === e.screenX ? e.touches[0].screenX : e.screenX),
                            (n.latestX = n.startX),
            ...
            o(n, [
                ...
                },
                {
                    ...
                    value: function (e, t, i) {
                        ...
                        n.table.element.classList.add("tabulator-block-select"),
                            e.stopPropagation(),
                            (n.startY = void 0 === e.screenY ? e.touches[0].screenY : e.screenY),
                                      ...
                                      (this.observer = new ResizeObserver(function (t) {
                                          if (!i.browserMobile || (i.browserMobile && !i.modules.edit.currentCell)) {
                                              ...
                                              (e.tableHeight == n && e.tableWidth == o) ||
                                                  ((e.tableHeight = n),
                                                  (e.tableWidth = o),
                                                  i.element.parentNode && ((e.containerHeight = i.element.parentNode.clientHeight), (e.containerWidth = i.element.parentNode.clientWidth)),
                                                  e.table.columnManager.renderer.rerenderColumns(!0),
                                                  i.redraw());
                                          }
                                      })),
                                      ...
                                      this.table.element.parentNode &&
                                          ...
                                          ((this.containerObserver = new ResizeObserver(function (t) {
                                              if (!i.browserMobile || (i.browserMobile && !i.modules.edit.currentCell)) {
                                                  var n = Math.floor(t[0].contentRect.height),
                                                      o = Math.floor(t[0].contentRect.width);
                                                  (e.containerHeight == n && e.containerWidth == o) || ((e.containerHeight = n), (e.containerWidth = o), (e.tableHeight = i.element.clientHeight), (e.tableWidth = i.element.clientWidth)),
            ...
            o(n, [
                {
                    ...
                    value: function () {
                        this.table.options.responsiveLayout &&
                            ...
                            "collapse" === this.table.options.responsiveLayout && (this.subscribe("row-init", this.initializeRow.bind(this)), this.subscribe("row-layout", this.layoutRow.bind(this))));
                    },
                },
                {
                    key: "tableRedraw",
                        ...
                        return (
                            this.hiddenColumns.forEach(function (a) {
                                ...
                                if (a.definition.title && a.field)
                                    if (a.modules.format && i.table.options.responsiveLayoutCollapseUseFormatters) {
                                        (t = {
                                            value: !1,
                                            data: {},
                                            getValue: function () {
                        ...
                        return (
                            e.forEach(function (e) {
                                ...
                                o.appendChild(r),
                                    ...
                                    e.value instanceof Node ? ((i = document.createElement("div")).appendChild(e.value), a.appendChild(i)) : (a.innerHTML = e.value),
                                    n.appendChild(o),
                                    n.appendChild(a),
                                    t.appendChild(n);
                            }, this),
    ...
    var Je = (function (i) {
        ...
        function r(e) {
            ...
            return (
                ...
                i.registerTableFunction("getSelectedRows", i.getSelectedRows.bind(l(i))),
                i.registerTableFunction("getSelectedData", i.getSelectedData.bind(l(i))),
                i.registerComponentFunction("row", "select", i.selectRows.bind(l(i))),
                i.registerComponentFunction("row", "deselect", i.deselectRows.bind(l(i))),
                i.registerComponentFunction("row", "toggleSelect", i.toggleRow.bind(l(i))),
                i.registerComponentFunction("row", "isSelected", i.isRowSelected.bind(l(i))),
                i
            );
        }
        return (
                    ...
                    value: function (e, t) {
                        ...
                        if (t.shiftKey) {
                            ...
                            t.ctrlKey || t.metaKey
                                ...
                                : (this.deselectRows(void 0, !0), !0 !== this.table.options.selectable && s.length > this.table.options.selectable && (s = s.slice(0, this.table.options.selectable)), this.selectRows(s)),
                    ...
                    value: function (e, t, i) {
                        ...
                        n
                            ? -1 == this.selectedRows.indexOf(n) &&
                              ...
                              n.modules.select.checkboxEl && (n.modules.select.checkboxEl.checked = !0),
                              this.selectedRows.push(n),
                              this.table.options.dataTreeSelectPropagate && this.childRowSelection(n, !0),
    ...
    var $e = {
            number: function (e, t, i, n, o, a, r) {
                var s = r.alignEmptyValues,
                    ...
                    c = 0;
                if (((e = String(e)), (t = String(t)), u && ((e = e.split(u).join("")), (t = t.split(u).join(""))), l && ((e = e.split(l).join(".")), (t = t.split(l).join("."))), (e = parseFloat(e)), (t = parseFloat(t)), isNaN(e)))
                    c = isNaN(t) ? 0 : -1;
                else {
            ...
            alphanum: function (e, t, i, n, o, a, r) {
                ...
                if (e || 0 === e) {
                    if (t || 0 === t) {
                        ...
                        for (s = s.match(m), l = l.match(m), h = s.length > l.length ? l.length : s.length; d < h; )
                            if ((u = s[d]) !== (c = l[d++])) return isFinite(u) && isFinite(c) ? ("0" === u.charAt(0) && (u = "." + u), "0" === c.charAt(0) && (c = "." + c), u - c) : u > c ? 1 : -1;
        ...
        Ze = (function (i) {
            ...
            function r(e) {
                ...
                return (
                    ...
                    i.registerTableOption("headerSortElement", "<div class='tabulator-arrow'></div>"),
                ...
                o(r, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            (t.modules.sort = { sorter: a, dir: "none", params: t.definition.sorterParams || {}, startingDir: t.definition.headerSortStartingDir || "asc", tristate: t.definition.headerSortTristate }),
                                !1 !== t.definition.headerSort &&
                                    ((i = t.getElement()).classList.add("tabulator-sortable"),
                                    (n = document.createElement("div")).classList.add("tabulator-col-sorter"),
                                    "object" == e(this.table.options.headerSortElement) ? n.appendChild(this.table.options.headerSortElement) : (n.innerHTML = this.table.options.headerSortElement),
                                    ...
                                    i.addEventListener("click", function (e) {
                                        ...
                                        if (t.modules.sort) {
                                            if (t.modules.sort.tristate)
                                                i = "none" == t.modules.sort.dir ? t.modules.sort.startingDir : t.modules.sort.dir == t.modules.sort.startingDir ? ("asc" == t.modules.sort.dir ? "desc" : "asc") : "none";
                                            else
                                            ...
                                            o.table.options.columnHeaderSortMulti && (e.shiftKey || e.ctrlKey)
                                                ? ((a = (n = o.getSort()).findIndex(function (e) {
                                                      return e.field === t.getField();
                                                  })) > -1
                                                      ? ((n[a].dir = i), a != n.length - 1 && ((a = n.splice(a, 1)[0]), "none" != i && n.push(a)))
                            ...
                            return (
                                ...
                                "remote" !== this.table.options.sortMode
                                    ? (i.forEach(function (e, i) {
                                          ...
                                          e.column && o && (o.sorter || (o.sorter = t.findSorter(e.column)), (e.params = "function" == typeof o.params ? o.params(e.column.getComponent(), e.dir) : o.params), n.push(e)),
                    ...
                    },
                    {
                        ...
                        value: function (e, t, i, n, o) {
                            ...
                            return (
                                ...
                                (a = s.getComponent()),
                                (r = l.getComponent()),
                                i.modules.sort.sorter.call(this, e, t, a, r, i.getComponent(), n, o)
                            );
                        },
                    },
                ]),
                    ...
                    value: function (e, t, i) {
                        ...
                        "function" == typeof i &&
                                ...
                                : ((n = document.createElement("div")),
                                  !0 === i &&
                                      (t instanceof w
                                          ? (i = t.value)
                                          : t.definition.field
                                          ? this.langBind("columns|" + t.definition.field, function (e) {
                            ...
                            (i || 0 === i || "0" === i || !1 === i) &&
                                ...
                                this.popupInstance.show(a.x + 15, a.y + 15).hideOnBlur(function () {
        ...
        tt = (function (i) {
            ...
            function r(e) {
                ...
                return (
                    ...
                    i.registerTableFunction("getInvalidCells", i.getInvalidCells.bind(l(i))),
                    i.registerTableFunction("clearCellValidation", i.userClearCellValidation.bind(l(i))),
                    i.registerTableFunction("validate", i.userValidate.bind(l(i))),
                    i.registerComponentFunction("cell", "isValid", i.cellIsValid.bind(l(i))),
                    i.registerComponentFunction("cell", "clearValidation", i.clearValidation.bind(l(i))),
                    i.registerComponentFunction("cell", "validate", i.cellValidate.bind(l(i))),
                    i.registerComponentFunction("column", "validate", i.columnValidate.bind(l(i))),
                    i.registerComponentFunction("row", "validate", i.rowValidate.bind(l(i))),
                    i
                );
            }
            return (
                        ...
                        value: function (e) {
                            ...
                            e.definition.validator &&
                                (Array.isArray(e.definition.validator)
                                    ...
                                    : (t = this._extractValidator(e.definition.validator)) && n.push(t),
                    ...
                    },
                    {
                        ...
                        value: function (e, t, i) {
                            ...
                            return (
                                ...
                                o.length
                                    ? ((t.modules.validate.invalid = o), "manual" !== this.table.options.validationMode && t.getElement().classList.add("tabulator-validation-fail"), -1 == a && this.invalidCells.push(t))
                                    : ((t.modules.validate.invalid = !1), t.getElement().classList.remove("tabulator-validation-fail"), a > -1 && this.invalidCells.splice(a, 1)),
                                !o.length || o
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            e.modules.validate &&
                                ...
                                (e.getElement().classList.remove("tabulator-validation-fail"), (e.modules.validate.invalid = !1), (t = this.invalidCells.indexOf(e)) > -1 && this.invalidCells.splice(t, 1));
                        },
                    },
                ]),
                r
